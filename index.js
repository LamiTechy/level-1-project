...
const renderSignUp = () => {
  app.innerHTML = `
    ...
    <div class="container mb-3 mx-auto">
      ...
      <button onclick="renderHome()" style="border-radius: 5px;">Home</button>
    </div>
  `;
  ...
  app.innerHTML = `
    <div class="container">
      ...
      <section>
        ...
        <p>You Looking Forward to Cut The Long Que . EasyBus provides an efficient and user-friendly way to travel. Cutting The Hassle Of Queing To Book Ticket.</p>
      </section>
      <section style="margin-top: 20px;">
        ...
        <ul>
          ...
          <section>
        <h2>EasyBus Got You Covered In All Ways!</h2>
        <p>Register Today And Kick-Start Your Of Gettingg Your Ticket In Your Own Comfort Zone.</p>
      </section>
      <section style="margin-top: 20px; text-align: center;">
        <button onclick="renderAbout()" style="border-radius: 5px;">Learn More</button>
        <button onclick="renderLogin()" style="border-radius: 5px;" class="logout">Login</button>
        <button onclick="renderSignUp()" style="border-radius: 5px;" class="logout">Sign Up</button>
      </section>
    </div>
  `;
};
...
const renderAbout = () => {
  app.innerHTML = `
    <div class="container">
      ...
      <button onclick="renderHome2()" style="border-radius: 5px;">Go Back</button>
...
const renderPaymentGateway = (ticketDetails) => {
  app.innerHTML = `
    <div class="container mb-3 mx-auto">
      ...
      <button onclick="renderHome2()" style="border-radius: 5px;">Cancel Payment</button>
    </div>
  `;
  ...
  if (bookings.length === 0) {
    app.innerHTML = `
      <div class="container">
        ...
        <button onclick="renderHome2()">Go Back</button>
      </div>
    `;
    return;
  }
